...
This project uses computer vision to automatically detect and sort waste items into six distinct categories: Trash, Plastic, metal, glass, paper and Biodegradable. This system integrates a custom-trained vision model with a physical control system to ensure only the correct bin opens.
